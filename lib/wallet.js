module.exports = function(options) {
  ...
  var DivvyAddress = require(__dirname+'/divvy_address.js')({ sjcl: options.sjcl });
  ...
  DivvyWallet.prototype = {
    ...
    getAddress: function(){
      ...
      return DivvyAddress.fromPublicKey(publicKey);
    }
  }

  DivvyWallet.getRandom = function(){
    var secretKey = MasterKey.getRandom().value;
    return new DivvyWallet(secretKey);
  };

  DivvyWallet.generate = function() {
    /* Generate a 128-bit master key that can be used to make 
       any number of private / public key pairs and accounts
    */
    var secretKey = MasterKey.getRandom().value;
    var wallet = new DivvyWallet(secretKey);
    return {
